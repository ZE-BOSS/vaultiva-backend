...
const all_exceptions_filter_1 = __webpack_require__(180);
const response_interceptor_1 = __webpack_require__(181);
const logging_interceptor_1 = __webpack_require__(183);
...
const wallet_module_1 = __webpack_require__(129);
const bills_module_1 = __webpack_require__(138);
const notifications_module_1 = __webpack_require__(126);
const payments_module_1 = __webpack_require__(133);
const health_module_1 = __webpack_require__(142);
const kyc_module_1 = __webpack_require__(145);
const escrow_module_1 = __webpack_require__(147);
const bill_splitting_module_1 = __webpack_require__(152);
const crowdfunding_module_1 = __webpack_require__(156);
const shared_wallets_module_1 = __webpack_require__(161);
const ai_insights_module_1 = __webpack_require__(166);
const rewards_module_1 = __webpack_require__(169);
const ledger_module_1 = __webpack_require__(172);
const transfers_module_1 = __webpack_require__(175);
...
const users_module_1 = __webpack_require__(115);
const jwt_strategy_1 = __webpack_require__(122);
const local_strategy_1 = __webpack_require__(124);
const notifications_module_1 = __webpack_require__(126);
const wallet_module_1 = __webpack_require__(129);
const user_entity_1 = __webpack_require__(21);
...
const wallet_service_1 = __webpack_require__(76);
const wallet_entity_1 = __webpack_require__(24);
...
let AuthService = AuthService_1 = class AuthService {
    ...
    codeIssued(identifier, delivered, resent = false) {
        return {
            message: delivered
    ...
    async register(createUserDto) {
        ...
        const delivered = await this.issueCode(identifier, exports.CodeCategory.SIGNUP);
    ...
    async completeProfile(contact, data) {
        ...
        try {
            let wallet = await this.walletService.findUserWalletByType(updated.id, wallet_entity_1.WalletType.MAIN);
            if (!wallet) {
            ...
            this.logger.error(`Wallet setup failed for user ${updated.id}`, error);
        }
...
const config_1 = __webpack_require__(4);
const verifymail_template_1 = __webpack_require__(71);
const email_provider_1 = __webpack_require__(72);
const sms_provider_1 = __webpack_require__(75);
let NotificationsService = NotificationsService_1 = class NotificationsService {
    ...
    get email() {
        return (this.emailProvider ??= (0, email_provider_1.resolveEmailProvider)(this.configService, this.logger));
    }
    get sms() {
        return (this.smsProvider ??= (0, sms_provider_1.resolveSmsProvider)(this.configService, this.logger));
    }
    async sendVerificationCode(recipient, name = '', code, type) {
        ...
        if (type === 'phone') {
            return this.sms.send(recipient, (0, verifymail_template_1.verifyMessage)(code));
        }
    ...
    async sendEmail(email, title, content) {
        try {
            ...
            this.logger.error(`Failed to send "${title}" to ${email}:`, error?.response?.data ?? error.message);
            throw error;
        }
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.resolveEmailProvider = resolveEmailProvider;
const axios_1 = __importDefault(__webpack_require__(73));
const zeptomail_1 = __webpack_require__(74);
const trim = (v) => (typeof v === 'string' ? v.trim() : '');
function resolveEmailProvider(config, logger) {
    ...
    const requireFrom = () => {
        if (!fromAddress) {
            throw new Error('MAIL_FROM is not set — the sender address must be on a domain you have ' +
    ...
    switch (chosen) {
        case 'resend': {
            ...
            return {
                ...
                async send(to, subject, html) {
                    await axios_1.default.post('https://api.resend.com/emails', { from: `${fromName} <${requireFrom()}>`, to: [to], subject, html }, { headers: { Authorization: `Bearer ${resend}` }, timeout: 15_000 });
                },
            };
        }
        case 'brevo': {
            if (!brevo)
                throw new Error('EMAIL_PROVIDER=brevo but BREVO_API_KEY is empty');
            return {
                name: 'brevo',
                async send(to, subject, html) {
        ...
        case 'zeptomail': {
            if (!zepto)
                throw new Error('EMAIL_PROVIDER=zeptomail but ZEPTO_API_KEY is empty');
            const url = trim(config.get('ZEPTO_URL')) || 'api.zeptomail.com/';
            return {
                name: 'zeptomail',
                async send(to, subject, html) {
                    const client = new zeptomail_1.SendMailClient({ url, token: zepto });
        ...
        case 'log': {
            if (config.get('NODE_ENV') === 'production') {
                throw new Error('No email provider is configured. Set RESEND_API_KEY (3,000/month free), ' +
            ...
            return {
                ...
                async send(to, subject, html) {
                    ...
                    logger.warn(`[email:log] No provider configured. To=${to} Subject="${subject}"` +
                        (code ? ` Code=${code}` : ''));
                },
            };
        }
        default:
            throw new Error(`EMAIL_PROVIDER="${chosen}" is not recognised. Use resend, brevo, zeptomail or log.`);
    }
}
...
function resolveSmsProvider(config, logger) {
    ...
    if (chosen === 'termii') {
        if (!apiKey)
            throw new Error('SMS_PROVIDER=termii but TERMII_API_KEY is empty');
        const post = async (to, message, channel) => {
            const { data } = await axios_1.default.post(`${baseUrl}/api/sms/send`, {
                to,
                from: senderId,
                sms: message,
                type: 'plain',
        ...
        return {
            ...
            async send(to, message) {
                try {
                    ...
                    logger.warn(`SMS to ${to} failed (${error.message}); trying WhatsApp.`);
    ...
    if (config.get('NODE_ENV') === 'production') {
        throw new Error('No SMS provider is configured. Set TERMII_API_KEY, or disable phone signup ' +
    ...
    return {
        ...
        async send(to, message) {
            ...
            logger.warn(`[sms:log] No provider configured. To=${to}` + (code ? ` Code=${code}` : ''));
        },
    };
}
...
const wallet_entity_1 = __webpack_require__(24);
const transaction_entity_1 = __webpack_require__(25);
const payments_service_1 = __webpack_require__(78);
...
const xpress_wallet_1 = __webpack_require__(79);
const config_1 = __webpack_require__(4);
const flutterwave_v3_1 = __importDefault(__webpack_require__(101));
...
var xpress_wallet_sdk_1 = __webpack_require__(80);
...
var http_client_1 = __webpack_require__(81);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.XpressWalletError = exports.XpressWalletSDK = void 0;
const http_client_1 = __webpack_require__(81);
const auth_service_1 = __webpack_require__(82);
const user_service_1 = __webpack_require__(83);
const customer_service_1 = __webpack_require__(84);
const wallet_service_1 = __webpack_require__(85);
const transaction_service_1 = __webpack_require__(86);
const transfer_service_1 = __webpack_require__(87);
const team_service_1 = __webpack_require__(88);
const merchant_service_1 = __webpack_require__(89);
const card_service_1 = __webpack_require__(90);
...
__exportStar(__webpack_require__(99), exports);
__exportStar(__webpack_require__(100), exports);
var http_client_2 = __webpack_require__(81);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const oas_1 = __importDefault(__webpack_require__(102));
const core_1 = __importDefault(__webpack_require__(103));
const openapi_json_1 = __importDefault(__webpack_require__(104));
class SDK {
    constructor() {
...
const throttler_1 = __webpack_require__(10);
const auth_service_1 = __webpack_require__(65);
const create_user_dto_1 = __webpack_require__(107);
const login_dto_1 = __webpack_require__(110);
const local_auth_guard_1 = __webpack_require__(111);
const public_decorator_1 = __webpack_require__(112);
const biometric_login_dto_1 = __webpack_require__(113);
const register_biometric_dto_1 = __webpack_require__(114);
...
const class_validator_1 = __webpack_require__(108);
const class_transformer_1 = __webpack_require__(22);
const swagger_1 = __webpack_require__(3);
const phone_transform_1 = __webpack_require__(109);
class CreateUserDto {
}
...
const user_entity_1 = __webpack_require__(21);
const encryption_util_1 = __webpack_require__(120);
...
const swagger_1 = __webpack_require__(3);
const users_service_1 = __webpack_require__(68);
const update_user_dto_1 = __webpack_require__(117);
const jwt_auth_guard_1 = __webpack_require__(118);
const roles_guard_1 = __webpack_require__(119);
const roles_decorator_1 = __webpack_require__(23);
...
const class_validator_1 = __webpack_require__(108);
const class_validator_2 = __webpack_require__(108);
const swagger_1 = __webpack_require__(3);
class UpdateUserDto {
}
...
const common_1 = __webpack_require__(2);
const CryptoJS = __importStar(__webpack_require__(121));
...
const common_1 = __webpack_require__(2);
const passport_1 = __webpack_require__(64);
const passport_jwt_1 = __webpack_require__(123);
const config_1 = __webpack_require__(4);
const users_service_1 = __webpack_require__(68);
...
const common_1 = __webpack_require__(2);
const passport_1 = __webpack_require__(64);
const passport_local_1 = __webpack_require__(125);
const auth_service_1 = __webpack_require__(65);
...
const typeorm_1 = __webpack_require__(8);
const notifications_service_1 = __webpack_require__(69);
const notifications_controller_1 = __webpack_require__(127);
const notification_entity_1 = __webpack_require__(26);
const axios_1 = __webpack_require__(70);
...
const notifications_service_1 = __webpack_require__(69);
const jwt_auth_guard_1 = __webpack_require__(118);
const positive_int_pipe_1 = __webpack_require__(128);
...
const bullmq_1 = __webpack_require__(9);
const wallet_service_1 = __webpack_require__(76);
const wallet_controller_1 = __webpack_require__(130);
const wallet_entity_1 = __webpack_require__(24);
const transaction_entity_1 = __webpack_require__(25);
const payments_module_1 = __webpack_require__(133);
const notifications_module_1 = __webpack_require__(126);
const transaction_processor_1 = __webpack_require__(137);
...
const swagger_1 = __webpack_require__(3);
const wallet_service_1 = __webpack_require__(76);
const create_wallet_dto_1 = __webpack_require__(131);
const withdraw_dto_1 = __webpack_require__(132);
const jwt_auth_guard_1 = __webpack_require__(118);
const public_decorator_1 = __webpack_require__(112);
const transaction_entity_1 = __webpack_require__(25);
const positive_int_pipe_1 = __webpack_require__(128);
...
const transaction_entity_1 = __webpack_require__(25);
const wallet_module_1 = __webpack_require__(129);
const flutterwave_module_1 = __webpack_require__(134);
...
const common_1 = __webpack_require__(2);
const flutterwave_service_1 = __webpack_require__(135);
const axios_1 = __webpack_require__(70);
...
const common_1 = __webpack_require__(2);
const config_1 = __webpack_require__(4);
const flutterwave_node_v3_1 = __importDefault(__webpack_require__(136));
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const bills_service_1 = __webpack_require__(139);
const bills_controller_1 = __webpack_require__(141);
const bill_entity_1 = __webpack_require__(19);
const bill_payment_entity_1 = __webpack_require__(20);
const recurring_payment_entity_1 = __webpack_require__(36);
const recurring_payments_service_1 = __webpack_require__(140);
const payments_module_1 = __webpack_require__(133);
...
const common_1 = __webpack_require__(2);
const health_controller_1 = __webpack_require__(143);
const health_service_1 = __webpack_require__(144);
...
const common_1 = __webpack_require__(2);
const kyc_service_1 = __webpack_require__(146);
const axios_1 = __webpack_require__(70);
const users_module_1 = __webpack_require__(115);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const escrow_service_1 = __webpack_require__(148);
const escrow_controller_1 = __webpack_require__(149);
const escrow_entity_1 = __webpack_require__(32);
const escrow_participant_entity_1 = __webpack_require__(33);
const wallet_module_1 = __webpack_require__(129);
const notifications_module_1 = __webpack_require__(126);
...
const swagger_1 = __webpack_require__(3);
const escrow_service_1 = __webpack_require__(148);
const create_escrow_dto_1 = __webpack_require__(150);
const update_escrow_dto_1 = __webpack_require__(151);
const jwt_auth_guard_1 = __webpack_require__(118);
const positive_int_pipe_1 = __webpack_require__(128);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const bill_splitting_service_1 = __webpack_require__(153);
const bill_splitting_controller_1 = __webpack_require__(154);
const bill_split_entity_1 = __webpack_require__(27);
const bill_split_participant_entity_1 = __webpack_require__(28);
const wallet_module_1 = __webpack_require__(129);
const notifications_module_1 = __webpack_require__(126);
...
const swagger_1 = __webpack_require__(3);
const bill_splitting_service_1 = __webpack_require__(153);
const create_bill_split_dto_1 = __webpack_require__(155);
const jwt_auth_guard_1 = __webpack_require__(118);
const positive_int_pipe_1 = __webpack_require__(128);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const crowdfunding_service_1 = __webpack_require__(157);
const crowdfunding_controller_1 = __webpack_require__(158);
const crowdfunding_campaign_entity_1 = __webpack_require__(30);
const crowdfunding_contribution_entity_1 = __webpack_require__(31);
const wallet_module_1 = __webpack_require__(129);
const notifications_module_1 = __webpack_require__(126);
...
const swagger_1 = __webpack_require__(3);
const crowdfunding_service_1 = __webpack_require__(157);
const create_campaign_dto_1 = __webpack_require__(159);
const contribute_dto_1 = __webpack_require__(160);
const jwt_auth_guard_1 = __webpack_require__(118);
const public_decorator_1 = __webpack_require__(112);
const positive_int_pipe_1 = __webpack_require__(128);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const shared_wallets_service_1 = __webpack_require__(162);
const shared_wallets_controller_1 = __webpack_require__(163);
const shared_wallet_entity_1 = __webpack_require__(41);
const shared_wallet_member_entity_1 = __webpack_require__(42);
const shared_wallet_transaction_entity_1 = __webpack_require__(43);
const transaction_signature_entity_1 = __webpack_require__(44);
...
const swagger_1 = __webpack_require__(3);
const shared_wallets_service_1 = __webpack_require__(162);
const create_shared_wallet_dto_1 = __webpack_require__(164);
const create_transaction_dto_1 = __webpack_require__(165);
const jwt_auth_guard_1 = __webpack_require__(118);
const positive_int_pipe_1 = __webpack_require__(128);
...
const typeorm_1 = __webpack_require__(8);
const axios_1 = __webpack_require__(70);
const ai_insights_service_1 = __webpack_require__(167);
const ai_insights_controller_1 = __webpack_require__(168);
const spending_insight_entity_1 = __webpack_require__(45);
const budget_recommendation_entity_1 = __webpack_require__(29);
const wallet_module_1 = __webpack_require__(129);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const rewards_service_1 = __webpack_require__(170);
const rewards_controller_1 = __webpack_require__(171);
const reward_entity_1 = __webpack_require__(37);
const user_reward_entity_1 = __webpack_require__(38);
const reward_rule_entity_1 = __webpack_require__(39);
const wallet_module_1 = __webpack_require__(129);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(8);
const ledger_service_1 = __webpack_require__(173);
const ledger_controller_1 = __webpack_require__(174);
const ledger_entry_entity_1 = __webpack_require__(34);
const reconciliation_record_entity_1 = __webpack_require__(35);
...
const typeorm_1 = __webpack_require__(8);
const bullmq_1 = __webpack_require__(9);
const transfers_service_1 = __webpack_require__(176);
const transfers_controller_1 = __webpack_require__(177);
const transfer_entity_1 = __webpack_require__(46);
const scheduled_transfer_entity_1 = __webpack_require__(40);
const bank_downtime_entity_1 = __webpack_require__(17);
const wallet_module_1 = __webpack_require__(129);
...
const swagger_1 = __webpack_require__(3);
const transfers_service_1 = __webpack_require__(176);
const create_transfer_dto_1 = __webpack_require__(178);
const create_scheduled_transfer_dto_1 = __webpack_require__(179);
const jwt_auth_guard_1 = __webpack_require__(118);
const positive_int_pipe_1 = __webpack_require__(128);
...
const common_1 = __webpack_require__(2);
const operators_1 = __webpack_require__(182);
